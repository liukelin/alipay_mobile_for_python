            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <input size="30" name="WIDout_trade_no" value='<?php echo $order_num;?>' />
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDsubject" value ='<?php echo 'test'.$order_num; ?>' />
                        <span>必填
</span>
                    </dd>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDshow_url" value="http://qiandeer.com" />
                        <span>必填
</span>
                    </dd>
                    <dt>订单描述：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbody" value ='<?php echo 'test order'.$order_num.'msg'; ?>' />
                        <span>选填
</span>
                    </dd>
                    <dt>超时时间：</dt>
